...
<script type="text/javascript">
  function validate(){
	  valid=true;
       if(document.fileupload.pdffile.value == "" ) {
        alert("Please attach a pdf file to be uploaded !");
        valid=false;}
       else {
           var value = document.fileupload.pdffile.value,
               ext = value.split(".").pop();
           if ( ext == "pdf" ) {
               return true; }
           else{
...
<body bgcolor="#E2E0E0">
	<div id="container">
		...
		<div id="content" style="min-height: 400px">
			<h2>Load Device Access Data</h2>
			<form:form id="pdf" modelAttribute="user" method="post"
				action="DevicePDFdataread.html" enctype="multipart/form-data"
				onsubmit="return validate();" name="fileupload">
				...
				<table align="center" bordercolor="#666666">
					...
					<tr>
						<td style="padding-right: 10px;"><font size="+1"> PDF
								File Date:</font></td>
						<td><input type="text" name="pdf_date" value="">
							&nbsp (MM/dd/yyyy)</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" align="center" style="padding-top: 20px"><input
							type="submit" value="Load to DB" onclick="return validate()"></td>
					</tr>
				</table>
