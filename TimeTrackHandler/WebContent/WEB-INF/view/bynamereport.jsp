...
<html>
<head>
<title>Employee Log Entry Report Handler</title>
...
function ValidateForm(){
	...
	var ename=document.daterangeform.eName.value
...
<body bgcolor="#E2E0E0">
	<div id="container">
		...
		<div id="content" style="min-height: 400px">
			<h2>Report By Employee Name</h2>

			<c:url var="recordsbyname" value="recordsbyname.html" />
			<form:form id="daterangeform" modelAttribute="user" method="post"
				action="${recordsbyname}" name="daterangeform"
				...
				<table align="center">
					...
					<tr>
						<td style="padding-right: 10px;"><font size="+1">
								Employee Name:</font></td>
						<td><input type="text" name="eName"></td>
					</tr>
					<tr>
						<td style="padding-right: 10px;"><font size="+1">
								Start Date:</font></td>
						<td><input type="text" name="timeIn"> &nbsp
							(MM/dd/yyyy)</td>
					</tr>
					<tr>
						<td style="padding-right: 10px;"><font size="+1"> End
								Date Date:</font></td>
						<td><input type="text" name="timeOut"> &nbsp
							(MM/dd/yyyy)</td>
					</tr>
					<tr>
				...
				<table border="1" align="center">
					...
					<c:forEach items="${user}" var="user">
						<tr>
							...
							<td><a
								href="bydateRangeview.html?eId=<c:out value="${user.eId}"/>&timein=<c:out value="${timein}"/>&timeout=<c:out value="${timeout}"/>">View
									Details</a></td>
						</tr>
					</c:forEach>
				</table>
				<%-- <p style="padding-left:300px;"><a href="exportExcel.html?timein=<c:out value="${timein}"/>&timeout=<c:out value="${timeout}"/>">Export to Excel</a></p> --%>
				<%-- <p style="padding-left:300px;"><a href="bynameexportExcel.html?ename=<c:out value="${eName}"/>&timein=<c:out value="${timein}"/>&timeout=<c:out value="${timeout}"/>">Export to Excel</a></p> --%>
			</c:if>
